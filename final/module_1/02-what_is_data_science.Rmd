...
```{r, echo=F}
knitr::include_graphics(file.path(figure_dir, "data.jpg"))
```
...
`r knitr::include_graphics("module_1/figures/data-science.png")`
...
`r knitr::include_graphics("module_1/figures/status.png")`

And if you're an MSIM student, you're far more likely to be one of those residential folks:

`r knitr::include_graphics("module_1/figures/status_by_program.png")`
...
`r knitr::include_graphics("module_1/figures/programming_stats_stacked.png")`

Finally, almost all of you are American:

`r knitr::include_graphics("module_1/figures/nationality.png")`
...
**TODO: replace dataset screenshots with inline R**
...
`r knitr::include_graphics("module_1/figures/salaries_dataset.png")`
...
`r knitr::include_graphics("module_1/figures/un_dataset.png")`
...
`r knitr::include_graphics("module_1/figures/suicide_dataset.png")`
...
`r knitr::include_graphics("module_1/figures/suicide_subset.png")`
...
`r knitr::include_graphics("module_1/figures/traffic_dataset.png")`
...
**todo**: revisit this, it denigrates exploratory analyses
