...
1. Get a set of data with a categorical outcome variable, like 'rank' in the `Salaries` dataset. Let's say we're using 'salary' and 'yrs.since.phd' as preditor variables.
...
Stay tuned next week for more supervised machine learning tools!
