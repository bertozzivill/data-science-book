...
`r knitr::include_graphics("module_2/figures/cylindrical_projection.gif")`
...
`r knitr::include_graphics("module_2/figures/Mercator_projection.jpg")`
...
`r knitr::include_graphics("module_2/figures/county_shapefile_us.png")`
...
`r knitr::include_graphics("module_2/figures/religion_categorical_usa.jpg")`
...
`r knitr::include_graphics("module_2/figures/choropleth_pop_usa_single_hue.jpg")`
...
`r knitr::include_graphics("module_2/figures/choropleth_pop_usa.jpg")`
...
`r knitr::include_graphics("module_2/figures/bad_pop_map.gif")`
...
`r knitr::include_graphics("module_2/figures/light_rail_simple.jpg")`
...
`r knitr::include_graphics("module_2/figures/light_rail_complex.jpg")`
...
`r knitr::include_graphics("module_2/figures/london_underground_old.jpg")`
...
`r knitr::include_graphics("module_2/figures/london_underground_new.jpg")`
...
`r knitr::include_graphics("module_2/figures/war_map.jpg")`
