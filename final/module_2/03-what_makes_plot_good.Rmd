...
`r knitr::include_graphics("module_2/figures/infx_dataset.png")`

And making visual representations of them:

`r knitr::include_graphics("module_2/figures/program_stats.png")`
...
`r knitr::include_graphics("module_2/figures/salaries.png")`
...
`r knitr::include_graphics("module_2/figures/cleveland_plot.png")`
...
`r knitr::include_graphics("module_2/figures/mindard_plot.png")`
...
`r knitr::include_graphics("module_2/figures/gbd_compare.png")`
...
`r knitr::include_graphics("module_2/figures/windmap_may21.png")`
...
`r knitr::include_graphics("module_2/figures/misleading_axis.png")`
...
`r knitr::include_graphics("module_2/figures/ethnicity_plot.png")`
...
`r knitr::include_graphics("module_2/figures/banana_export.png")`
